...
# 7. L, K, I, H, E 열 삭제 (오른쪽에서 왼쪽으로)
for col in ['L', 'K', 'I', 'H', 'E']:
    new_sheet.Columns(col).Delete()

# 8. I5, J5 셀 삭제
new_sheet.Range("I5:J5").Delete()

# 9. 첫 행의 데이터가 있는 부분 배경색 변경, 글꼴 굵게, 가운데 정렬
